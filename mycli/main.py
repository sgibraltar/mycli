...
class MyCli(object):
    ...
    def __init__(
        ...
        self.logger = logging.getLogger(f'mycli.{__name__}')
    ...
    def initialize_logging(self):
        ...
        root_logger = logging.getLogger(logging.root.name)
    ...
    def refresh_completions(self, reset=False, scoped_db_name=None, prev_dbmetadata=None):
        if reset:
            with self._completer_lock:
        ...
        self.completion_refresher.refresh(
            ...
            scoped_db_name=scoped_db_name,
            prev_dbmetadata=prev_dbmetadata,
        )
    ...
    def _on_completions_refreshed(self, new_completer):
        ...
        with self._completer_lock:
            new_completer.refresh_functions = [self.refresh_completions]
    ...
    def get_prompt(self, string):
        ...
        string = string.replace("\\h", sqlexecute.aurora_server_id or host or "(none)")
        string = string.replace("\\d", f'({sqlexecute.dbname}) ' if sqlexecute.dbname else "")
